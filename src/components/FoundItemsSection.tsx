    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        {items.length === 0 ? (
          ...
          <>
            <RevealStagger className="mt-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              {items.map((it) => {
                ...
                return (
                  <Reveal key={it.id} /* preset="zoom" (opsional) */>
                    <article className="group relative bg-white rounded-2xl shadow-lg p-6 border border-slate-100 hover:-translate-y-1 hover:shadow-xl transition-all">
