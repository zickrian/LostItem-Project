      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div className="max-w-md w-full">
          ...
          <div className="relative group">
            ...
            <div className="absolute -inset-0.5 bg-gradient-to-br from-cyan-400/30 via-blue-500/20 to-blue-600/30 rounded-3xl blur-2xl opacity-50 group-hover:opacity-70 transition duration-700"></div>
            
            {/* Card */}
            <div className="relative bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden border border-white/30">
              ...
              <div className="relative p-8">
                <div className="text-center mb-8">
                  ...
                  <div className="mb-6 transform transition-all duration-300 hover:scale-105">
                    <div className="relative inline-block p-4">
                      ...
                      {/* Animated ring */}
                      <div className="absolute inset-0 rounded-3xl border-2 border-blue-400/20 animate-pulse-slow"></div>
                      <img
                        src="https://dinus.ac.id/wp-content/uploads/2023/11/LogoUdinus.png"
                        alt="Logo UDINUS"
                        className="relative w-28 h-28 mx-auto object-contain drop-shadow-lg"
                      />
                    </div>
                  </div>
                  
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-700 bg-clip-text text-transparent mb-3 animate-fade-in">
                    Selamat Datang! 🌊
                  </h2>
                ...
                <div className="mt-6 relative overflow-hidden">
                  ...
                  <div className="relative p-4 border border-blue-300/50 rounded-xl backdrop-blur-sm">
                    <p className="text-sm text-gray-800 text-center leading-relaxed">
                      ...
                      <span className="font-mono text-blue-600 bg-blue-100/80 px-2 py-1 rounded font-semibold">Kampus</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center mt-8">
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white/20 backdrop-blur-md text-white hover:bg-white/30 transition-all duration-300 rounded-full border border-white/30 group hover:shadow-lg hover:shadow-white/20"
            >
              <svg
