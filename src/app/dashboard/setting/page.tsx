  ...
  return (
    <DashboardLayout>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6 sm:mb-8">Pengaturan</h1>

        <form onSubmit={handleSaveSettings} className="space-y-4 sm:space-y-6">
          {/* Profile Settings */}
          <div className="bg-white rounded-xl shadow-md p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Profil Saya</h2>
          ...
          <div className="bg-white rounded-xl shadow-md p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">Notifikasi</h2>
          ...
          <button
            type="submit"
            disabled={saving}
            className="w-full text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors font-semibold text-sm sm:text-base"
        ...
        {/* Danger Zone */}
  <div className="bg-red-50 border-2 border-red-200 rounded-xl p-4 sm:p-6 mt-4 sm:mt-6">
          <h2 className="text-xl sm:text-2xl font-bold text-red-900 mb-3 sm:mb-4">⚠️ Danger Zone</h2>
